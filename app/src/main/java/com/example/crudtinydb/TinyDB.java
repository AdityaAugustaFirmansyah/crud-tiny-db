...
public class TinyDB {
    ...
    public ArrayList<AnimeModel> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<AnimeModel> objects = new ArrayList<>();

    	for(String jObjString : objStrings){
    		AnimeModel value  = gson.fromJson(jObjString,AnimeModel.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<AnimeModel> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(AnimeModel obj : objArray){
